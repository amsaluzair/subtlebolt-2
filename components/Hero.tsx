    ...
    <section className="relative pt-32 pb-24 md:pt-48 md:pb-32 overflow-hidden bg-white">
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-6 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-bold text-slate-900 tracking-tight leading-[1.1] mb-8">
          We’ll Book <span className="marker-highlight">30+ Qualified</span><br className="hidden md:block" /> Sales Calls In 90 Days
        </h1>
        ...
        {/* Video Embed */}
        <div className={`relative mx-auto bg-white rounded-2xl shadow-2xl shadow-slate-200 border border-slate-100 mb-16 overflow-hidden ${!isVideoPlaying ? 'group cursor-pointer transform transition-transform hover:scale-[1.01]' : ''}`} style={{ width: '2880px', height: '1750px', maxWidth: '100%' }}>
          {!isVideoPlaying ? (
